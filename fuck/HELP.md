...
* The following dependencies are not known to work with Spring Native: 'Influx, Spring Boot DevTools, Spring REST Docs'.
...
```
$ docker run --rm shit:0.0.1-SNAPSHOT
```
